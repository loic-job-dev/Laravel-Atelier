...
<div class="container">
  <div class="row">
    <div class="col-md-12 mb-4">
      ...
      <a href={{url ('/product/1') }} class="btn btn-custom">AJOUTER AU PANIER</a>
    </div>
    ...
    <div class="col-md-12 mb-4">
      ...
      <a href={{url ('/product/2') }} class="btn btn-custom">AJOUTER AU PANIER</a>
    </div>
  </div>
</div>
    ...
    <div class="col-md-6 mb-4">
      ...
      <a href={{url ('/product/3') }} class="btn btn-custom">AJOUTER AU PANIER</a>
    </div>

    <div class="col-md-6 mb-4">
      <img src="/pictures/exemple.jpg" alt="Parfum" class="img-fluid">
      <h2>Brise de Jasmin. Eau de Parfum</h2>
       <a href={{url ('/product/4') }} class="btn btn-custom">AJOUTER AU PANIER</a>
    </div>

    <div class="col-md-6 mb-4">
      <img src="/pictures/exemple.jpg" alt="Parfum" class="img-fluid">
      <h2>Lagune d'Iris. Eau de Parfum</h2>
       <a href={{url ('/product/5') }} class="btn btn-custom">AJOUTER AU PANIER</a>
    </div>

    <div class="col-md-6 mb-4">
      <img src="/pictures/exemple.jpg" alt="Parfum" class="img-fluid">
      <h2>Soleil d'Ete. Eau de parfum</h2>
       <a href={{url ('/product/6') }} class="btn btn-custom">AJOUTER AU PANIER</a>
    </div>
