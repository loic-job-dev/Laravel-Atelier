<html lang="eng">
    ...
    <div class="container">
        <a class="navbar-brand" href="{{ route('backoffice.products.index') }}">Backoffice</a>
        <a class="btn btn-outline-light" href="{{ route('backoffice.products.create') }}">Ajouter un produit</a>
    </div>
</nav>
        </header>
